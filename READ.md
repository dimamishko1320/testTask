...
+ GET /account/{id} - получить amount по определенному {id}
+ PUT /account/{id}/{amount} - добавить на счет с {id} amount 
+ GET /statistic - получить статистику вызова методов - общую и за единицу времени
+ DELETE /statistic - сбросить статистику